...
def convert_hierarchy_to_cm(hierarchy_str):
    def scale_offset(match):
        nums = [float(x) * 100 for x in match.group(1).split()]
...
def quat_to_euler(q):
    # R = quat2mat([q[3], q[0], q[1], q[2]])  # x,y,z,w → w,x,y,z

    # return mat2euler(R, axes='rzyx')  # ZYX 순
    return quat2euler([q[3], q[0], q[1], q[2]], axes='rzyx')  
...
# export_bvh_from_pkl("CLoSD_t2m_finetune-jump_length_400.pkl", "closdtest_jump.bvh")
# print("closdtest_jump.bvh!!!")

# export_bvh_from_pkl("CLoSD_t2m_finetune_1env_sit.pkl", "closdtest_250528_sit.bvh")
# print("closdtest_250528_sit.bvh!!!")

export_bvh_from_pkl("CLoSD_t2m_finetune_1env_writhe.pkl", "closdtest_250528_writhe.bvh")
print("closdtest_250528_writhe.bvh!!!")